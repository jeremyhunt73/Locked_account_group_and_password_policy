...
<h2>Description</h2>
In this project i will be installing a second machine to my virtual environment, in this case it will be the latest version of Windows (Windows 11). Also, I joined Server 2016 to the new machine's domain, the which grant me access to Server 2016 from the Windows 11 machine.
<br />
